...
gulp.task('build-dev', gulp.series('img', 'scss', 'css', 'webpack', 'fonts', 'html', 'favicon', gulp.parallel('watch', 'server')));

gulp.task('build-prod', gulp.series(gulp.parallel('img', 'scss', 'css', 'webpack', 'fonts', 'html', 'favicon')));
